...
const IGNORE_NAME = /(^static\/chunks\/|static\/_buildManifest-[0-9a-f]+\.js)/
const IGNORE_CONTENT = new RegExp(
  [
    ...
    // TODO These contain
    // - content-hashed browser chunk urls, but are not deployed to the serverless function itself,
    ...
    const { next } = nextTestSetup({
      files: {
        ...
        'next.config.js': `module.exports = {
            experimental: {
              staticDeploymentId: "some-static-id",
